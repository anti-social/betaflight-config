...
#define BOARD_NAME        KARMA405V1
#define MANUFACTURER_ID   KRMA
...
#define PINIO3_PIN PA0
#define MAX7456_SPI_CS_PIN PC14
#define GYRO_1_EXTI_PIN PC4
#define GYRO_1_CS_PIN PA4
/*
#define TIMER_PIN_MAPPING \
    TIMER_PIN_MAP( 0, PC8,  2, 0 ) \  // TIM3_CH3
    TIMER_PIN_MAP( 1, PC9,  2, 0 ) \  // TIM3_CH3
    TIMER_PIN_MAP( 2, PA8,  1, 0 ) \  // TIM1_CH1
    TIMER_PIN_MAP( 3, PA9,  1, 0 ) \  // TIM1_CH2
    TIMER_PIN_MAP( 4, PB15, 3, -1 ) \  // TIM8_CH3N
    TIMER_PIN_MAP( 5, PB10, 1, -1 ) \  // TIM2_CH3
    TIMER_PIN_MAP( 6, PA0, 2, 0 ) \  // TIM5_CH1
    TIMER_PIN_MAP( 7, PA3, 3, -2)
*/
...
#define DEFAULT_CURRENT_METER_SCALE 75
#define DEFAULT_CURRENT_METER_OFFSET -1780
#define DEFAULT_VOLTAGE_METER_SCALE 221
